...
flowchart TB
    subgraph MULL["Mulligan 換牌"]
        ...
        MU4 --> MU5[MU5: syncMulliganStatus true]
        MU5 --> MU6[MU6: syncGameAction MULLIGAN_DONE]
        MU6 --> MU7[MU7: 隱藏 Modal 顯示等待]
        MU7 --> MU8[MU8: listenMulliganStatus]
        MU8 --> MU9{MU9: 雙方都完成?}
        MU9 -->|否| MU10[MU10: 等待對手]
        MU9 -->|是| MU11[MU11: 手牌動畫顯示]
