...
const DEFAULT_THEME_DECKS = {
    ...
    kmt2: [
        // --- 1費卡牌 ---
        'S009', 'S009',   // 政治切割 (新聞) x2
        'TW039', 'TW039', // 徐巧芯 x2
        'S014', 'S014',   // 側翼出動 (新聞) x2
        'TW054', 'TW054', // 鋼鐵韓粉 x2

        // --- 2費卡牌 ---
        'TW030',          // 朱立倫 x1
        'S008', 'S008',   // 法院傳票 (新聞) x2
        'TW040', 'TW040', // 謝龍介 x2
    ...
    tpp: [
        ...
        'TW021', 'TW021', // 黃國昌 x2 (衝蹦+激怒)
        'TW026', 'TW026', // 黃珊珊 x2 (光盾+沙包)
